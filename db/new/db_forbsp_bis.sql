...
--
-- Host: localhost:3306
-- Generation Time: Dec 12, 2023 at 09:18 PM
...
CREATE TABLE `master_cabang` (
  ...
  `nomor_seri_pajak` text,
  `no_izin` text,
  `akhir_bulan_berlaku` datetime DEFAULT NULL,
  `penangung_jawab` text,
  `sik_aa` text,
